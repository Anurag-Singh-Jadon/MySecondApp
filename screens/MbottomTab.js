...
const activeHome = (isPlay) => {
    return (
        <View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/bar.json`)} autoPlay={isPlay} loop={false} />
        </View>
    )
}
...
const activeList = (isPlay) => {
    return (
        <View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/cart.json`)} autoPlay={isPlay} loop={false} />
        </View>
    )
}
...
const activeCamera = (isPlay) => {
    return (
        <View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/search.json`)} autoPlay={isPlay} loop={false} />
        </View>
    )
}
...
const activeNotification = (isPlay) => {
    return (
        <View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/setting.json`)} autoPlay={isPlay} loop={false} />
        </View>
    )
}
...
const activeUser = (isPlay) => {
    return (
        <View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/user.json`)} autoPlay={isPlay} loop={false} />
        </View>
    )
}
...
const tabData = [
    {
        ...
        inactiveIcon: (<View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/bar.json`)} autoPlay={false} loop={false} />
        </View>)
    ...
    },
    {
        ...
        activeIcon: null,
        inactiveIcon: (<View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/cart.json`)} autoPlay={false} loop={false} />
        </View>)
    },
    {
        name: 'Search',
        activeIcon: null,
        inactiveIcon: (<View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/search.json`)} autoPlay={false} loop={false} />
        </View>)
    },

    {
        ...
        activeIcon: null,
        inactiveIcon: (<View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/user.json`)} autoPlay={false} loop={false} />
        </View>)
    },
    {
        name: 'Setting',
        activeIcon: null,
        inactiveIcon: (<View style={{ width: 40, height: 40 }}>
            <LottieView source={require(`../Assets/NTUSER.DAT/setting.json`)} autoPlay={false} loop={false} />
        </View>)
    },
]
