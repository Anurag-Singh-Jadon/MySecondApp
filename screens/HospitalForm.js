...
import { LogBox, SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
const HospitalForm = () => {
    ...
    const onChange = (event, value) => {
        console.log("on change value result")
        ...
        console.log("DAte time Value===" + fDate + '(' + fTime + ')')
    };
            ...
            <View style={styles.inputContainer}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.dob}>
                        <View style={{ width: wp('50%'), height: hp('7%'), flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: wp('3%') }}>
                            <View style={{ width: wp('48%'), height: hp('7%'), backgroundColor: 'pink', alignItems: 'center', justifyContent: 'center' }}>
                                {/* <Text style={{ fontSize: hp('1.5%') }} >{date.toUTCString()}</Text> */}
                                <Text style={{ fontSize: hp('1.5%') }} >{text}</Text>
                            </View>
                            {!isDatePickerVisible && (
                                <TouchableOpacity style={{ width: wp('4%'), height: hp('7%'), backgroundColor: 'blue' }} onPress={showDatePicker}>
                    ...
                    <TouchableOpacity style={styles.button} onPress={validForm} >
                        <Text onPress={validForm} style={{ color: 'white', fontSize: hp('3%') }}>Submit</Text>
                    </TouchableOpacity>
